...
public class BaseStation {
	...
	private int microphoneValue = 0;
	private int lightValue = 0;
	private int ultraValue = 0;
	private GUI theGUI;
	...
	public void establishConnection() throws NXTCommException, IOException {
		...
		info = new NXTInfo(NXTCommFactory.BLUETOOTH, "TROGDOR",
				"00:16:53:13:E6:74"); // your robot's name must be NXT and the
										// code is 123
		...
		/*
		 * oHandle.close(); iHandle.close(); os.close(); is.close();
		 * connection.close(); readFlag = false;
		 */
	}
